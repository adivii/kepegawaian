        ...
        $result = $result."
            <tr>
                ...
                <td class=\"bg-transparent modifier-button\">
                    <button type=\"button\" class=\"btn btn-primary w-100\" onClick=\"edit_data(".$row['id_agenda'].")\">Edit</button>
                    <button type=\"button\" class=\"btn btn-danger w-100 mt-1\" onClick=\"hapus_data(".$row['id_agenda'].")\">Hapus</button>
                </td>
            </tr>
        ";
    }
